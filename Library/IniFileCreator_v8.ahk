...
that can be used with the DL_IniSettingsEditor function.
...
features:
=========
- compatible with DL_IniSettingsEditor function
...
IniFile = %A_ScriptDir%\Library\IniFileCreator_v8.ini
...
;#Include %A_ScriptDir%\Library\DL_Func_IniSettingsEditor_v6.ahk
 ;#Include %A_ScriptDir%\Library\DL_Func_DL_IniSettingsEditor_v6.ahk
; ##Include DL_Func_DL_IniSettingsEditor_v6.ahk
...
; Else'
;   Gui, 1:Add, Bu'tton, vBtnOpenINI gBtnOpenINI Section x15 y60 disabled , Open Ini
...
GuiPos= x10 y20
; vGuiSize= h750
Gui, 1:Show, %GuiPos% %vGuiSize%, %ScriptName% - Create Ini file for DL_IniSettingsEditor 
Gui, 1:+LastFound
; guicontrol, disable, vBtnOpenINI
  ; guicontrol, disable, vBtnEmptyINI
GuiID := WinExist() 
...
BtnTestIni:
  ...
  DL_IniSettingsEditor("Test Ini", IniFile, 1, 1)
  FileDelete, %IniFile%  
Return
...
GoSub, CheckSaveState 
MsgBox, 292,, Do you want to exit the program?
ifMsgBox, Yes
	ExitApp
IfMsgBox, No
{
...
; Anchorversion taken from http://www.autohotkey.com/forum/viewtopic.php?t=4348, renamed to avoid naming conflicts.
GuiIniFileCreatorSize:
If ResizeAllControls {
      ;       ControlName        , xwyh with factors [, True for MoveDraw]
      DL_GuiIniFileCreatorAnchor("TrvSelect"         ,"w0.5h")      
      DL_GuiIniFileCreatorAnchor("BtnAdd"            ,"y",true)  
      DL_GuiIniFileCreatorAnchor("EdtName"           ,"yw0.5")      
      DL_GuiIniFileCreatorAnchor("BtnRemove"         ,"x0.5y",true) 
      DL_GuiIniFileCreatorAnchor("DdlKeyType"        ,"x0.5")       
      DL_GuiIniFileCreatorAnchor("EdtKeyFormat"      ,"x0.5w0.5")       
      DL_GuiIniFileCreatorAnchor("EdtKeyValue"       ,"x0.5w0.5")       
      DL_GuiIniFileCreatorAnchor("ChkKeyDefault"     ,"x0.5",true)  
      DL_GuiIniFileCreatorAnchor("ChkKeyHidden"      ,"x0.5",true)  
      DL_GuiIniFileCreatorAnchor("BtnBrowseKeyValueEditor" ,"x",true) 
      DL_GuiIniFileCreatorAnchor("DatKeyValue"       ,"x0.5w0.5")       
      DL_GuiIniFileCreatorAnchor("HotKeyValue"       ,"x0.5w0.5")       
      DL_GuiIniFileCreatorAnchor("DdlKeyValue"       ,"x0.5w0.5")       
      DL_GuiIniFileCreatorAnchor("ChkKeyValue"       ,"x0.5")       
      DL_GuiIniFileCreatorAnchor("EdtChkName"        ,"x0.5w0.5")       
      DL_GuiIniFileCreatorAnchor("EdtKeyOptions"     ,"x0.5w0.5")     
      DL_GuiIniFileCreatorAnchor("EdtKeyDes"         ,"x0.5w0.5h")      
      DL_GuiIniFileCreatorAnchor("EdtIniFile"        ,"x0.5w0.5y")      
      DL_GuiIniFileCreatorAnchor("BtnBrowseIniFile"  ,"xy",true) 
      DL_GuiIniFileCreatorAnchor("BtnSaveToFile"     ,"x0.5y",true) 
      DL_GuiIniFileCreatorAnchor("BtnTestIni"        ,"x0.5y",true) 
      DL_GuiIniFileCreatorAnchor("Grb"               ,"wh",true) 
      DL_GuiIniFileCreatorAnchor("TxtType"           ,"x0.5")       
      DL_GuiIniFileCreatorAnchor("TxtFormat"         ,"x0.5w0.5")       
      DL_GuiIniFileCreatorAnchor("TxtValue"          ,"x0.5")       
      DL_GuiIniFileCreatorAnchor("TxtOptions"        ,"x0.5")       
      DL_GuiIniFileCreatorAnchor("TxtDescription"    ,"x0.5")       
      DL_GuiIniFileCreatorAnchor("TxtIniFile"        ,"x0.5y")
      DL_GuiIniFileCreatorAnchor("TxtHeadline"       ,"x0.5")
  }Else{
      ;       ControlName        , xwyh with factors [, True for MoveDraw]
      DL_GuiIniFileCreatorAnchor("TrvSelect"         ,"wh")      
      DL_GuiIniFileCreatorAnchor("BtnAdd"            ,"y",true)  
      DL_GuiIniFileCreatorAnchor("EdtName"           ,"yw")      
      DL_GuiIniFileCreatorAnchor("BtnRemove"         ,"xy",true) 
      DL_GuiIniFileCreatorAnchor("DdlKeyType"        ,"x")       
      DL_GuiIniFileCreatorAnchor("EdtKeyFormat"      ,"x")       
      DL_GuiIniFileCreatorAnchor("EdtKeyValue"       ,"x")       
      DL_GuiIniFileCreatorAnchor("ChkKeyDefault"     ,"x",true)  
      DL_GuiIniFileCreatorAnchor("ChkKeyHidden"      ,"x",true)  
      DL_GuiIniFileCreatorAnchor("BtnBrowseKeyValueEditor" ,"x",true) 
      DL_GuiIniFileCreatorAnchor("DatKeyValue"       ,"x")       
      DL_GuiIniFileCreatorAnchor("HotKeyValue"       ,"x")       
      DL_GuiIniFileCreatorAnchor("DdlKeyValue"       ,"x")       
      DL_GuiIniFileCreatorAnchor("ChkKeyValue"       ,"x")       
      DL_GuiIniFileCreatorAnchor("EdtChkName"        ,"x")       
      DL_GuiIniFileCreatorAnchor("EdtKeyOptions"     ,"x")     
      DL_GuiIniFileCreatorAnchor("EdtKeyDes"         ,"xh")      
      DL_GuiIniFileCreatorAnchor("EdtIniFile"        ,"xy")      
      DL_GuiIniFileCreatorAnchor("BtnBrowseIniFile"  ,"xy",true) 
      DL_GuiIniFileCreatorAnchor("BtnSaveToFile"     ,"x0.5y",true) 
      DL_GuiIniFileCreatorAnchor("BtnTestIni"        ,"x0.5y",true) 
      DL_GuiIniFileCreatorAnchor("Grb"               ,"wh",true) 
      DL_GuiIniFileCreatorAnchor("TxtType"           ,"x")       
      DL_GuiIniFileCreatorAnchor("TxtFormat"         ,"x")       
      DL_GuiIniFileCreatorAnchor("TxtValue"          ,"x")       
      DL_GuiIniFileCreatorAnchor("TxtOptions"        ,"x")       
      DL_GuiIniFileCreatorAnchor("TxtDescription"    ,"x")       
      DL_GuiIniFileCreatorAnchor("TxtIniFile"        ,"xy")
      DL_GuiIniFileCreatorAnchor("TxtHeadline"       ,"x0.5")
    }
Return
...
DL_GuiIniFileCreatorAnchor(i, a = "", r = false) {
