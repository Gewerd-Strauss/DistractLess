...
DL_IniSettingsEditor(ProgName,IniFile,OwnedBy = 0,DisableGui = 0, ShowHidden = 0) {
	static pos
	;m(A_ScriptName,"edited, DL-version")	
   ...
   ;; OLD VERSION - more compact. I prefer a bigger gui when editing, as I often have much longer variable names and texts
		...
		Gui, Add, Button, x250 y335 w70 h30 gDL_ExitSettings , E&xit     ;ahk_class Button1
		Gui, Add, Button, x505 y88 gDL_BtnBrowseKeyValue Hidden, B&rowse ;ahk_class Button2
		Gui, Add, Button, x215 y274 gDL_BtnDefaultValue, &Restore        ;ahk_class Button3
    ...
    ; Gui, Add, Edit, x360 y114 w340 h20,                           ;ahk_class Edit1
		...
		Gui, Add, Button, x390 y533 w70 h30 gDL_ExitSettings , E&xit     ;ahk_class Button1
		Gui, Add, Button, x505 y88 gDL_BtnBrowseKeyValue Hidden, B&rowse ;ahk_class Button2
		Gui, Add, Button, x505 y533 w70 h30 gDL_BtnDefaultValue, &Restore        ;ahk_class Button3
...
;;; when selecting 'CheckBox' as your next type. 
	...
	DL_GuiIniSettingsEditorSize:
	DL_GuiIniSettingsEditorAnchor("SysTreeView321"      , "wh") 
	DL_GuiIniSettingsEditorAnchor("Edit1"               , "x")
	DL_GuiIniSettingsEditorAnchor("Edit2"               , "xh")
	DL_GuiIniSettingsEditorAnchor("Button1"             , "xy",true)
	DL_GuiIniSettingsEditorAnchor("Button2"             , "x",true)
	DL_GuiIniSettingsEditorAnchor("Button3"             , "xy",true)
	DL_GuiIniSettingsEditorAnchor("Button4"             , "x",true)
	DL_GuiIniSettingsEditorAnchor("Button5"             , "wh",true)
	DL_GuiIniSettingsEditorAnchor("SysDateTimePick321"  , "x")
	DL_GuiIniSettingsEditorAnchor("msctls_Hotkey321"    , "x")
	DL_GuiIniSettingsEditorAnchor("ComboBox1"           , "x")
	DL_GuiIniSettingsEditorAnchor("Static1"             , "x")
	DL_GuiIniSettingsEditorAnchor("Static2"             , "x")
	DL_GuiIniSettingsEditorAnchor("Static3"             , "x")
	DL_GuiIniSettingsEditorAnchor("Static4"             , "x")
	Return 
}  ;end of function

DL_GuiIniSettingsEditorAnchor(ctrl, a, draw = false) { ; v3.2 by Titan (shortened)
	static pos
	sig = `n%ctrl%=
	If !InStr(pos, sig) {
